			...
			<div>
				...
				<div>
					{PICTURES.map(picture => (
						<Link key={picture.id} to={{pathname: `/pictures/${picture.id}`, state: {model: true, returnTo: this.props.location.pathname}}}>
	...
	render() {
		return (
			<div>
				...
				<p>
					<Link to={{pathname: `/pictures/0`, state: {modal: true, returnTo: this.props.location.pathname}}}>
